...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [NUM_L] = LAYOUT_split_3x6_3(
       KC_ESC,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                         KC_6,    KC_7,    KC_8,    KC_9,    KC_0,   LLOCK,
      KC_LCTL,  OS_ALT,  OS_GUI, OS_CTRL, OS_SHFT, KC_TILD,                         KC_0, OS_SHFT, OS_CTRL,  OS_GUI,  OS_ALT, _______,
